...
package Janelas.Gasto;

/**
 *
 * @author Douglas
 */
public class Cadastro_Gasto extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_Gasto1
     */
    public Cadastro_Gasto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Gasto")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("Cadastro_Gasto")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Gasto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastro_Gasto dialog = new Cadastro_Gasto(new javax.swing.JFrame(), true);
