 ...
 * @author Douglas
 */
public class Cadastro_Tipo_Medicamento extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_Tipo_Medicamento1
     */
    public Cadastro_Tipo_Medicamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Tipo_Medicamento")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("Cadastro_Tipo_Medicamento")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Tipo_Medicamento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastro_Tipo_Medicamento dialog = new Cadastro_Tipo_Medicamento(new javax.swing.JFrame(), true);
