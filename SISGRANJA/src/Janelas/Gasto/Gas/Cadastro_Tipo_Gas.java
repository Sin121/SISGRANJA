 ...
 * @author Douglas
 */
public class Cadastro_Tipo_Gas extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_Tipo_Gas1
     */
    public Cadastro_Tipo_Gas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Tipo_Gas")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("Cadastro_Tipo_Gas")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Tipo_Gas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastro_Tipo_Gas dialog = new Cadastro_Tipo_Gas(new javax.swing.JFrame(), true);
