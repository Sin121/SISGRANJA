 ...
 * @author Douglas
 */
public class Cadastro_Lote_Vacina extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_Lote_Vacina1
     */
    public Cadastro_Lote_Vacina(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Lote_Vacina")); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText(bundle.getString("Cadastro_Lote_Vacina")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Lote_Vacina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastro_Lote_Vacina dialog = new Cadastro_Lote_Vacina(new javax.swing.JFrame(), true);
