 ...
 * @author Douglas
 */
public class Horas_Luz_Dia extends javax.swing.JFrame {

    /**
     * Creates new form Mortalidade
     */
    public Horas_Luz_Dia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Horas_Luz_Dia")); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText(bundle.getString("Horas_Luz_Dia")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Horas_Luz_Dia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Horas_Luz_Dia().setVisible(true);
            }
        });
    }
