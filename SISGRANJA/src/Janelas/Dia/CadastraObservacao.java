 ...
 * @author Douglas
 */
public class CadastraObservacao extends javax.swing.JDialog {
    private Gerencia_Dia gerencia_dia;
    private String observacao = null;

    /**
     * Creates new form CadastraObservacao
     */
    public CadastraObservacao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public void setObservacao(String observacao) {
        ...
        jTextArea1.setText(this.observacao);
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Observacao")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("Cadastro_Observacao")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        gerencia_dia.setMensagem(jTextArea1.getText());
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastraObservacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastraObservacao dialog = new CadastraObservacao(new javax.swing.JFrame(), true);
