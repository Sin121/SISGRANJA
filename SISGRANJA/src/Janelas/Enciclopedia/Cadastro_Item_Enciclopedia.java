...
package Janelas.Enciclopedia;

/**
 *
 * @author Douglas
 */
public class Cadastro_Item_Enciclopedia extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_Item_Enciclopedia1
     */
    public Cadastro_Item_Enciclopedia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Item_Enciclopedia")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("Cadastro_Item_Enciclopedia")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Item_Enciclopedia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastro_Item_Enciclopedia dialog = new Cadastro_Item_Enciclopedia(new javax.swing.JFrame(), true);
