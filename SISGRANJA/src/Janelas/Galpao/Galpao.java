 ...
 * @author Douglas
 */
public class Galpao extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Galpao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
