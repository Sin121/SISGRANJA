...
package Janelas.Linhagem;

/**
 *
 * @author Douglas
 */
public class Cadastro_Linhagem extends javax.swing.JDialog {

    /**
     * Creates new form Cadastro_Linhagem1
     */
    public Cadastro_Linhagem(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle(bundle.getString("Cadastro_Linhagem")); // NOI18N
        ...
        jLabel1.setText(bundle.getString("Cadastro_Linhagem")); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cadastro_Linhagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Cadastro_Linhagem dialog = new Cadastro_Linhagem(new javax.swing.JFrame(), true);
